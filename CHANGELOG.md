...
- HMI inverters (MI800/HMI-2000): New *Error Active* sensor (a problem indicator) reflects whether the device currently has a real fault, separately from *Error Type*, which can show a code even for a benign condition like low panel voltage at dusk. Experimental: not yet confirmed whether this clears back to "off" after a fault is resolved
- Docs: Add [docs/hmi.md](docs/hmi.md), documenting the MQTT protocol of the HMI micro inverters (MI800/HMI-2000)
